...
botoes.forEach((botao, indice) => {
  botao.addEventListener("click", () => {
    ...
    //passo 3 (objetivo 1) - verificar se já existe um botão selecionado, se sim, devemos remover a seleção dele 
    desselecionarBotao();

    //passo 2 (objetivo 1) - adicionar a classe "selecionado" no botão que o usuário clicou
    botao.classList.add("selecionado");


    //passo 3 (objetivo 2) - verificar se já exista um personagem selecionado, se sim, devemos remover 
